        ...
        return _regenerator.default.wrap(function (_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                _ref = _args6.length > 0 && _args6[0] !== undefined ? _args6[0] : {}, chain = _ref.chain, address = _ref.address, tokenAddress = _ref.tokenAddress;
                _context8.next = 3;
        ...
        return _regenerator.default.wrap(function (_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                _ref2 = _args7.length > 0 && _args7[0] !== undefined ? _args7[0] : {}, chain = _ref2.chain, address = _ref2.address, symbol = _ref2.symbol;
